...
export const SigninRedirect: FC = () => {
    ...
    useEffect(()=>{console.log('useEffect called'); {updateState(state+1)}}, [signInStatus])
    ...
    {
        return <div>Your account is not activated. Please click the link on the email sent to you to activate your account.</div>
    }
