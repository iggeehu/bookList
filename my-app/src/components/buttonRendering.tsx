...
export const ButtonRendering: FC<props> = (props) => {
  ...
  const dropDownOfLists = () => {
    if (auth === null || auth === "") {
      ...
      return <AddToList bookId={props.idElem} myLists={myLists} />;
    }
  };
  ...
  return (
    ...
    >
      <button
        className="m-auto ease-in-out hover:bg-slate-500"
        onClick={() => seeDetails(props.idElem, navigate, ":fromSearch")}
      >
      ...
      <div className="">
        ...
        <div className="inline absolute mt-10 p-2">
